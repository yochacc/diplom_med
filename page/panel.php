...
<body class="top">
    ...
    <a  class="css-modal-open" href="#uslugi"> Услуги </a>
    <a  class="css-modal-open" href="#clients"> Клиенты </a>

<a  class="css-modal-open" href="#uslug-add"> Добавить услугу  </a>
<a  class="css-modal-open" href="#analiz-add"> Добавить анализ  </a>
<a  class="css-modal-open" href="#pr-add"> Добавить специальность  </a>
<a  class="css-modal-open" href="#prd-add"> Привязать специальность </a>
<a  class="css-modal-open" href="#photo-add">Добавить фотo</a>
...
<a  class="hidden" href="#photo-add"></a>
...
<h2 align="center" id="uslugi" >Мед.Услуги</h2>
...
<section class="section service-3" >
			...
			<div class="col-lg-4 col-md-6 col-sm-6">
				<div class="serviceaimg">
					...
					<div class="content">
						...
						<a  class="css-modal-open" href="#uslug-edit<?=$i.'000'?>"> Изменить</a>
					</div>
				</div>
			</div>
  ...
  <? for($i = 0; $i < count($data['products']); $i++){ ?> 
    ...
    <div class="dm-overlay" id="uslug-edit<?=$i.'000'?>">
    <div class="dm-table">
        <div class="dm-cell">
            <div class="dm-modal">
	...
	<form action="/app/doctor.php" method="POST" >
						<div class='field'>
							<label for='Lemail'>Название</label><br>
							<input type="text" name="name_f" id="login"  minlength="1" value="<?=$data['products'][$i]['name']?>" style="display:none">

							<input type="text"name="name" id="login"  minlength="1" placeholder="Введите название"  required minlength="4" maxlength="30" required value="<?=$data['products'][$i]['name']?>">
						</div>
						<div class='field'>
							<label for='Lpass'>Описание</label><br>
							<input type="text" name="desc" id="name" required minlength="1" placeholder="Введите описание" required value="<?=$data['products'][$i]['desc']?>">
						</div>

						<div class='field'>
							<label for='Lpass'>Цена</label><br>
							<input type="text" name="price" id="name" required minlength="1" placeholder="Введите цену" required value="<?=$data['products'][$i]['price']?>"><br>
						</div>
            


						<div class='field'>
							<input type="file" name="img" id="name" required minlength="1" placeholder="Название картинки" required value="<?=$data['products'][$i]['img']?>"><br>
						</div>
